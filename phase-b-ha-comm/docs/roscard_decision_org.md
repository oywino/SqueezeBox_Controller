...
- Empty evidence directory placeholder: `docs/roscard_evidence/` (to be filled in Step 8.2+).
- Scoring sheet stub: `docs/roscard_scoring.md` (table only, filled later).

## Acceptance Checklist (Step 8.1)

- [ ] Document exists with criteria, weights, thresholds, and protocol.
- [ ] No code changes introduced.
- [ ] PLAN/STATE note “Step 8.1 criteria defined” pending review.
